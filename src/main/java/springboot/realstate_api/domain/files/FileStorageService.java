package springboot.realstate_api.domain.files;
...
public class FileStorageService {
    ...
    public String storeFile(MultipartFile file) {
        // Normalize file name
        String fileName = StringUtils.cleanPath(UUID.randomUUID().getLeastSignificantBits()+"_"+file.getOriginalFilename().replaceAll(" ", ""));
